...
CREATE TABLE `cart`  (
  `ID_CART` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`ID_CART`, `ID_USER`, `ID_PR`) USING BTREE,
...
-- Records of cart
-- ----------------------------
INSERT INTO `cart` VALUES ('c1', 'user1', 'prod1', 1);
INSERT INTO `cart` VALUES ('c1', 'user1', 'prod10', 1);
INSERT INTO `cart` VALUES ('c1', 'user1', 'prod2', 2);
INSERT INTO `cart` VALUES ('c1', 'user1', 'prod22', 1);
INSERT INTO `cart` VALUES ('c1', 'user1', 'prod3', 1);
INSERT INTO `cart` VALUES ('c2', 'user2', 'prod1', 1);
INSERT INTO `cart` VALUES ('c2', 'user2', 'prod46', 2);
...
-- Records of ct_pr
-- ----------------------------
INSERT INTO `ct_pr` VALUES ('prod1', '2021-12-20', '2024-01-10', 'Coop Seclect', 'Gạo có hạt thon dài, màu trắng trong, cơm dẻo vừa, thơm nhẹ.Chất lượng gạo đạt tiêu chuẩn xuất khẩu.Không chất bảo quản, không chất tạo mùi,không dư lượng thuốc trừ sâu.Cơm sau khi nấu có độ dẻo vừa, mềm, ngon và có mùi thơm nhẹ.', 0.3, 'Việt Nam', '2022-09-15', 182, 0);
INSERT INTO `ct_pr` VALUES ('prod2', '2022-09-03', '2023-08-21', 'Coop Select', 'Gạo có hạt thon dài, màu trắng trong, cơm dẻo vừa, thơm nhẹ.Chất lượng gạo đạt tiêu chuẩn xuất khẩu.Không chất bảo quản, không chất tạo mùi,không dư lượng thuốc trừ sâu.Cơm sau khi nấu có độ dẻo vừa, mềm, ngon và có mùi thơm nhẹ.', 5, 'Việt Nam', '2022-12-13', 164, 0);
...
-- Records of discount
-- ----------------------------
INSERT INTO `discount` VALUES ('v1', 10, 'GIAMGIA20K', 20000, b'0');
INSERT INTO `discount` VALUES ('v2', 23, 'GIAMGIA10K', 10000, b'0');
INSERT INTO `discount` VALUES ('v3', 30, 'GIAMGIA5', 5, b'1');
INSERT INTO `discount` VALUES ('v4', 4, 'GIAMGIA15K', 15000, b'0');
INSERT INTO `discount` VALUES ('v5', 5, 'GIAMGIA25K', 25000, b'0');
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('orders1', '0384837922', '20/234 Số 3,Linh Trung, Thủ Đức, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', NULL, 1);
INSERT INTO `orders` VALUES ('orders10', '0380007922', '234 Số 3,Hoàng Dịu, Thủ Đức, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', NULL, 0);
INSERT INTO `orders` VALUES ('orders11', '0384837922', '20/234 Số 3,Linh Trung, Thủ Đức, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', NULL, 0);
INSERT INTO `orders` VALUES ('orders2', '0384800238', '1/23 Võ Văn Ngân,Thánh Gióng,Quận 5, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', 'Đừng có giao lúc ngủ', 2);
INSERT INTO `orders` VALUES ('orders3', '0384834392', '230 Man Thiện, Tăng Nhơn Phú A, Thủ Đức, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', 'Bắp lựa sống 1 tý', 1);
INSERT INTO `orders` VALUES ('orders4', '0273467482', '20/234 Số 3,Linh Trung, Thủ Đức, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', 'Cho xin 3 cái túi nilong', 2);
INSERT INTO `orders` VALUES ('orders5', '0244348988', '23 Hiệp Bình, Võ Thị Sáu,Quận 5, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', NULL, 3);
INSERT INTO `orders` VALUES ('orders6', '0777384922', '20/234 Số 3,Linh Trung, Thủ Đức, Hồ Chí Mình', '2022-03-12 10:35:29', '2022-03-12 12:35:29', NULL, 1);
INSERT INTO `orders` VALUES ('orders7', '0993420027', '23 Hiệp Bình, Võ Thị Sáu,Quận 5, Hồ Chí Mình', '2022-11-23 10:35:29', '2022-11-23 12:35:29', 'Khoai không hư nhá', 2);
INSERT INTO `orders` VALUES ('orders8', '0456837922', '20/234 Số 3,Linh Trung, Thủ Đức, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', NULL, 0);
INSERT INTO `orders` VALUES ('orders9', '0384833332', '234 Số 3,Văn Ngân, Thủ Đức, Hồ Chí Mình', '2022-05-08 10:35:29', '2022-05-08 12:35:29', NULL, 0);
...
CREATE TABLE `sold_pr`  (
  `ID_PR` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ID_USER` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `TIME-SOLD` datetime NULL DEFAULT NULL COMMENT 'thời gian bán',
  `AMOUNT` int NULL DEFAULT NULL,
  `ID_ORDERS` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
